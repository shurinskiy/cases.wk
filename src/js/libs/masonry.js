...
export const masonryBuilder = (element, options = {}) => {
	class Masonry {
		...
		setLayout() {
			...
			// количество элементов в колонках
			...
			// наименьшая высота колонки
			const minHeightColumn = Math.min(...heightColumns);
			// насколько обрезать ячейку снизу и сверху, чтобы все колонки стали одинаковыми по высоте
